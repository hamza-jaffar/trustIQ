import { show } from '@/routes/installments'
...
const ProfileInstallment = ({ installment }: { installment: Installment }) => {
    ...
    return (
        <Link className='cursor-pointer' href={show({ id: installment.id })}>
                ...
                <div className="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <p className="text-xl font-bold text-gray-900 dark:text-gray-200">
                            {currency.symbol} {Number(installment.total_payable).toLocaleString()}
                        </p>
                    </div>
                ...
                <div className="mt-4 grid grid-cols-3 divide-x rounded-lg border bg-background py-3">
                    <div className="px-3 text-center">
                        ...
                        <p className="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-200">
                            {currency.symbol} {Number(installment.total_price).toLocaleString()}
                        </p>
                    </div>
                    ...
                    <div className="px-3 text-center">
                        ...
                        <p className="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-200">
                            {currency.symbol} {Number(installment.down_payment).toLocaleString()}
                        </p>
                    </div>
                    ...
                    <div className="px-3 text-center">
                        ...
                        <p className="mt-1 text-sm font-semibold text-gray-900 dark:text-gray-200">
                            {currency.symbol} {Number(installment.flat_markup).toLocaleString()}
                        </p>
                    </div>
                </div>
            </div>
